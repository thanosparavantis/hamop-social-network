        ...
        <div className="container max-w-2xl">
          ...
          <section className="bg-white px-5 py-20 shadow border-t text-center">
            ...
            <div className="text-gray-700">
              <p className="mb-5">
                <strong className="text-indigo-600">Ενισχύστε</strong> την
                παρουσία σας δημιουργώντας ένα προφίλ
              </p>
              <p className="mb-5">
                <strong className="text-indigo-600">Μοιραστείτε</strong> ιδέες και
                απόψεις για γεγονότα που σας ενδιαφέρουν
              </p>
              <p className="mb-5">
                <strong className="text-indigo-600">Αλληλεπιδράστε</strong> με την
                κοινότητα των χρηστών στην Ελλάδα
              </p>
              <p>
                <strong className="text-indigo-600">Κερδίστε</strong> βραβεία
